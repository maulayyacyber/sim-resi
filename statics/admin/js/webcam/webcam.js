...
var site = "/" + pathArray[1] + "/cms/assets/themes/administrator/";
var webcam_files = pathArray[0] + "/cms/assets/themes/administrator/";
...
window.webcam = {
  ...
  swf_url: webcam_files+'js/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
  shutter_url: webcam_files+'js/webcam/shutter.mp3', // URI to shutter.mp3 sound
