...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php print base_url() ?>statics/admin/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body class="body-404">
    ...
    <div class="container ">
      ...
      <section class="error-wrapper text-center">
          <h1><img src="<?php print base_url() ?>statics/admin/images/404.png" alt=""></h1>
          <div class="error-desk">
              <h2>page not found</h2>
              <p class="nrml-txt">We Couldn’t Find This Page</p>
          </div>
          <a href="<?php print base_url() ?>" class="back-btn"><i class="fa fa-home"></i> Back To Home</a>
      </section>
